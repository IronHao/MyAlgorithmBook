...
public:
    WeightedCompressedQuickUnionUF(int nrOfNode)
    {
    ...
    ~WeightedCompressedQuickUnionUF()
    {
        delete[] _parent;
    }
...
int main()
{
    ...
    WeightedCompressedQuickUnionUF qf = WeightedCompressedQuickUnionUF(stoi(string(buf)));
